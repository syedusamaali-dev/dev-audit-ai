    ...
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        <div style={styles.brand}>
          ...
          <h1 style={styles.title}>DevAudit <span style={styles.accentText}>Studio</span></h1>
        </div>
          ...
          <div style={styles.resultsContainer}>
            {loading && (
              <div style={styles.placeholderState}>
                ...
                <p>Analyzing AST structure, security risks & optimization paths...</p>
              </div>
            )}
            ...
            {!loading && !result && !error && (
              <div style={styles.placeholderState}>
                <p>Paste code on the left and click <strong>⚡ Audit Code</strong> to run analysis.</p>
              </div>
            )}
            ...
            {!loading && result && (
              <div style={styles.reportContent}>
                ...
                {/* Vulnerabilities */}
                <div style={styles.card}>
                  <h3 style={{ ...styles.cardHeader, color: '#FF5555' }}>Vulnerabilities Detected</h3>
                ...
                {/* Performance */}
                <div style={styles.card}>
                  <h3 style={{ ...styles.cardHeader, color: '#50FA7B' }}>Performance & Quality</h3>
                  {result.performanceFixes?.length > 0 ? (
                    ...
                    <p style={styles.cleanText}>No performance issues identified.</p>
                  )}
                </div>

                {/* Refactored Code */}
                <div style={styles.card}>
                  <h3 style={{ ...styles.cardHeader, color: '#8BE9FD' }}>Refactored Output</h3>
